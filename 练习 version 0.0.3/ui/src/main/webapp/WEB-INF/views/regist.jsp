				...
				<form action="list" method="post" onSubmit="return regs('click')">
					<table class="form_table">
						...
						<tr>
							...
							<td valign="middle" align="left"><input type="text"
								class="inputgri" name="info_name" /><span class="tips">&nbsp;真实姓名不能为空</span></td>
						</tr>
						<tr>
							<td valign="middle" align="right">性别:</td>
							<td valign="middle" align="left"><input type="text"
								class="inputgri" name="info_gender" /><span class="tips">&nbsp;性别不能为空</span></td>
						</tr>
						<tr>
							<td valign="middle" align="right">身份证号:</td>
							<td valign="middle" align="left"><input type="text"
								class="inputgri" name="info_card" /><span class="tips">&nbsp;身份证号不能为空</span></td>
						</tr>
						<tr>
							<td valign="middle" align="right">联系电话:</td>
							<td valign="middle" align="left"><input type="text"
								class="inputgri" name="info_phone" /><span class="tips">&nbsp;联系电话不能为空</span></td>
						</tr>
						<tr>
							<td valign="middle" align="right">邮箱地址:</td>
							<td valign="middle" align="left"><input type="text"
								class="inputgri" name="info_email" /><span class="tips">&nbsp;邮箱地址不能为空</span></td>
						</tr>
						<tr>
							<td valign="middle" align="right">密保问题:</td>
							<td valign="middle" align="left"><input type="text"
								class="inputgri" name="info_question" /><span class="tips">&nbsp;密保问题不能为空</span></td>
						</tr>
						<tr>
							<td valign="middle" align="right">密保答案:</td>
							<td valign="middle" align="left"><input type="text"
								class="inputgri" name="info_answer" /><span class="tips">&nbsp;密保答案不能为空</span></td>
						</tr>
						<tr>
