	...
	<div id="wrap">
		<div id="top_content">
			<div id="header">
				...
				<div id="navigation">
					<p style="line-height: 0px; color: white;">
						&nbsp;&nbsp;欢迎你:&nbsp;${account}<span>&nbsp;&nbsp;<a
							style="color: white;" href="/java/Login/show">登出</a></span>
					</p>
				</div>
			</div>
			<div id="content">
				...
				<h1>Welcome!</h1>
				<div align="right">
					请输入关键字 <input type="text" class="inputgri" name="lookingfor" /> <input
						type="button" class="button" value="Go &raquo;" />
				</div>
				<br />
